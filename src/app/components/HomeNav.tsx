...
const baseLinks = ["Home", "About", "Tools", "Projects", "Certifications"];
        ...
        <div className="relative flex flex-col items-center w-full py-2 sm:py-0 overflow-x-hidden">
            <div className="flex items-center select-none mb-4 sm:mb-0 sm:absolute sm:left-4 sm:top-1/2 sm:-translate-y-1/2">
                <Link href="/home" className="hover:opacity-80 transition-all active:scale-95 cursor-pointer">
                    <span className="text-[26px] font-bold font-decorative text-gray-900 dark:text-white tracking-tight">Akshat.</span>
                </Link>
            </div>
            ...
            <nav className="w-full flex justify-center items-center sm:h-20 px-2 sm:px-0">
                <ul 
                    ...
                    style={{ 
                        ...
                        maxWidth: isExpanded ? '600px' : '550px'
                    }}
                >
